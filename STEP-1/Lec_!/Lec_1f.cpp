...
//(Note : time omplexity is calculated in terms of worst case scenerios usually, avoid constants and avoid lower values)

// example : 
//for(int i =0; i<n; i++){ cout << "Raj"}; ---> O(3n) {n times for loop and 3 times extra for sum (cout statement,check,increment step of i) };
